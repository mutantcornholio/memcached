...
`memecached` is a fork of https://github.com/3rd-Eden/memcached
Development of original is frozen and they don't even accept patches anymore. I'm not sure about active development here, but you're free to send PR's.   
...
``` js
var Memcached = require('memecached');
